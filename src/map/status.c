		...
		case SC_DANCING:
			{
				...
				{// erase associated land skill
					...
					if( group == NULL )
					{
						ShowDebug("status_change_end: Esta faltando unit group da habilidade SC_DANCING (val1=%d, val2=%d, val3=%d, val4=%d, timer=%d, tid=%d, char_id=%d, map=%s, x=%d, y=%d, prev=%s:%d, from=%s:%d). Favor reportar isso! (#3504)\n",
